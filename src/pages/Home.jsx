...
export default function Homex() {
  ...
  return (
    <div className="min-h-screen bg-[url('/h1.jpg')] bg-no-repeat bg-linear-to-br from-gray-200 via-gray-100 to-gray-200 relative overflow-hidden">
      ...
      <Navbar/>
        ...
        className="text-gray-800 text-lg md:text-lg max-w-2xl mx-auto"
      >
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 place-content-center items-center">
    ...
    <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 h-[350px]  hover:shadow-2xl transition-all duration-300">
      <h2 className="text-xl font-semibold mb-4 bg-linear-to-r from-red-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
      ...
      <button className="mt-8 text-sm bg-gradient-to-r  from-indigo-600 via-purple-500 to-pink-500 text-white font-semibold px-6 py-3 rounded-full shadow hover:scale-105 transition-transform" onClick={()=> navigate('/generate')}>
        Try It Now
      </button>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-lg   rounded-3xl p-8 shadow-lg  h-[450px] bg-linear-to-b from-blue-100 to-green-100 flex flex-col items-center justify-center hover:shadow-2xl transition-all duration-300">
      ...
      <h2 className="text-3xl font-semibold mb-4 z-10 bg-gradient-to-r from-black via-50% to-black/10 bg-clip-text text-transparent">
      ...
      <div className="flex flex-col items-center space-y-4">
        <div className="w-20 h-20 bg-gradient-to-r from-yellow-200 via-red-100 animate-bounce to-blue-100 rounded-full flex items-center justify-center text-black font-bold text-2xl shadow-lg">
          AI
        </div>
        <p className="text-gray-500 text-sm">Smart Visual Recognition</p>
      </div>

      <button className="mt-8 text-sm bg-gradient-to-r from-amber-500 via-30% to-amber-500 text-white font-semibold px-6 py-3 rounded-full shadow hover:scale-105 transition-transform" onClick={()=> navigate('/generate')}>
        Upload Image
      </button>
    </div>
    ...
    <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-8 h-[400px] hover:shadow-2xl transition-all duration-300">
      <h2 className="text-xl font-semibold mb-4 bg-linear-to-r from-orange-400 via-rose-500 to-red-600 bg-clip-text text-transparent">
        SEO & Tag Optimizer
      </h2>
      <p className="text-gray-600 mb-6">
      ...
      <div className="space-y-2">
        <p className="border border-gray-400 rounded-2xl p-4 text-sm text-gray-700 shadow-sm">
        ...
        <p className="border border-gray-400 rounded-2xl p-4 text-xs text-gray-700 shadow-sm">
          <strong>SEO Tags:</strong> #kurti #womenfashion #affordablewear
        </p>
      </div>

      <button className="mt-8 text-sm w-full bg-gradient-to-r from-orange-400 via-rose-500 to-red-600 text-white font-semibold px-6 py-3 rounded-full shadow hover:scale-105 transition-transform" onClick={()=> navigate('/generate')}>
        Optimize My Listing
      </button>
    </div>
  </div>
